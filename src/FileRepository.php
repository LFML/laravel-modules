...
use Laravel\Modules\Exceptions\InvalidAssetPath;
use Laravel\Modules\Exceptions\ModuleNotFoundException;
use Laravel\Modules\Process\Installer;
use Laravel\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
    ...
    public function getModulePath($module)
    {
        try {
            ...
            return module_make_path([$this->getPath(), Str::studly($module)]) . DIRECTORY_SEPARATOR;
        }
    }
    ...
    {
        return module_make_path([$this->config('paths.assets'), $module]);
    }
     ...
     * @return string
     * @throws \Laravel\Modules\Exceptions\ModuleNotFoundException
     */
