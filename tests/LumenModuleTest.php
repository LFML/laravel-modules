...
class LumenModuleTest extends BaseTestCase
{
    ...
    {
        $this->assertEquals('Laravel/recipe', $this->module->getComposerAttr('name'));
    }
...
class LumenTestingModule extends \Laravel\Modules\Lumen\Module
{
}
