...
use Laravel\Modules\Collection;
...
class LaravelFileRepositoryTest extends BaseTestCase
{
    ...
    public function it_gets_the_configured_stubs_path_if_enabled()
    {
        ...
        $this->assertEquals(base_path('vendor/Laravel/laravel-modules/src/Commands/stubs'), $this->repository->getStubPath());
    }
